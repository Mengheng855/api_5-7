                    ...
                    <div class="product-item">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div class="flex-grow-1">
                                <div class="fw-semibold">Standard Plan</div>
                                <div class="text-muted small">892 sales</div>
                            </div>
                            <div class="text-success fw-semibold">$17,748</div>
                        </div>
                    </div>
                    <div class="product-item">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="text-muted small">654 sales</div>
                            </div>
                            <div class="text-success fw-semibold">$6,474</div>
                        </div>
                    </div>
                    <div class="product-item">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="text-muted small">321 sales</div>
                            </div>
                            <div class="text-success fw-semibold">$19,239</div>
                        </div>
                    </div>
                </div>
            </div>
